...
while True:
    ...
    try:
        match opcion:
            ...
            case _:
                print("Opción inválida. Ingrese un número entre 1 y 19, o 'terminado' para salir.")
    except ValueError:
        print("Error: ingresaste una letra o un texto donde es un número. Intenta de nuevo.")